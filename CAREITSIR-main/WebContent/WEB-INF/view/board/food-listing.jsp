	...
	<div class="main-container container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-12">
				...
				<div class="sidearea-filter">
					...
					<h6 class="sidearea-filter-title">카페 상세정보</h6>
					...
					<div class="sidearea-filter-checkbox-list">
						...
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" value="option3"> 디저트판매
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
						...
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" value="option7"> 애견동반
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" value="option8"> 주차공간
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
						...
						<div class="form-check">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" value="option9"> 흡연구역
							</label>
						</div>
						<div class="form-check">
					...
					<div class="list-box clearfix">
						...
						<div class="float-lg-left list-box-info">
							<h5 class="list-box-info-title">
								<a href="food-details.html">37.5 동탄점</a>
							</h5>
                     ...
                     onclick="trackEvent('CLICK_RESTAURANT', {&quot;position&quot;:0,&quot;restaurant_key&quot;:&quot;3JyWTs_O5vx1&quot;})">
                      <div class="restaurant-more-text">더보기 ></div>
							...
							<ul class="list-unstyled list-inline list-box-info-tags">
								<li class="list-inline-item"><a href="#">테라스</a></li>
					...
					<div class="hotels-list text-xs-center text-sm-center text-lg-left">
						...
						<div class="list-box clearfix">
							...
							<div class="float-lg-left list-box-info">
								...
								<ul class="list-unstyled list-inline list-box-info-tags">
									<li class="list-inline-item"><a href="#">테라스</a>,</li>
									<li class="list-inline-item"><a href="#">루프탑</a>
								</ul>
								<ul
									class="list-unstyled list-inline list-box-info-description text-weight-bold">
						...
						<div
							...
							<div class="list-box clearfix">
								...
								<div class="float-lg-left list-box-info">
									...
									<ul class="list-unstyled list-inline list-box-info-tags">
										<li class="list-inline-item"><a href="#">테라스</a>,</li>
										<li class="list-inline-item"><a href="#">루프탑</a>,</li>
										<li class="list-inline-item"><a href="#">와이파이</a>
									</ul>
									<ul
										class="list-unstyled list-inline list-box-info-description text-weight-bold">
									</ul>
								...
								<div class="list-box clearfix">
									...
									<div class="float-lg-left list-box-info">
										...
										<ul class="list-unstyled list-inline list-box-info-tags">
											<li class="list-inline-item"><a href="#">테라스</a>,</li>
											<li class="list-inline-item"><a href="#">루프탑</a>,</li>
											<li class="list-inline-item"><a href="#">와이파이</a>,</li>
											<li class="list-inline-item"><a href="#">애견동반</a>
										</ul>
										<ul
											class="list-unstyled list-inline list-box-info-description text-weight-bold">
									...
									<div class="list-box clearfix">
										...
										<div class="float-lg-left list-box-info">
											...
											<ul class="list-unstyled list-inline list-box-info-tags">
												...
												<li class="list-inline-item"><a href="#">루프탑</a>,</li>
												<li class="list-inline-item"><a href="#">와이파이</a>,</li>
												<li class="list-inline-item"><a href="#">애견동반</a>,</li>
												<li class="list-inline-item"><a href="#">노키즈존</a>
											</ul>
											<ul
												class="list-unstyled list-inline list-box-info-description text-weight-bold">
										...
										<div class="list-box clearfix">
											...
											<div class="float-lg-left list-box-info">
												...
												<ul class="list-unstyled list-inline list-box-info-tags">
													...
													<li class="list-inline-item"><a href="#">와이파이</a>,</li>
													<li class="list-inline-item"><a href="#">애견동반</a>,</li>
													<li class="list-inline-item"><a href="#">노키즈존</a>,</li>
													<li class="list-inline-item"><a href="#">흡연구역</a></li>
												</ul>
												<ul
													class="list-unstyled list-inline list-box-info-description text-weight-bold">
		...
		<!-- Nested Container Starts -->
			...
			<!-- Starts -->
				...
				<!-- Logo Starts -->
					<div class="col-lg-3 col-sm-12 text-xs-center text-sm-center text-lg-left">
						<img src="<%=request.getContextPath()%>/CARE/images/logo.png" alt="FoodBingo" class="img-fluid">
					</div>
				<!-- Logo Ends -->
				<!-- Page Links Starts -->
				...
				<!-- Social Media Links Starts -->
					<div class="col-lg-3 col-sm-12">
						<ul class="list-unstyled list-inline sm-links text-xs-center text-sm-center text-lg-right">
			...
			<!-- Address Section Starts -->
				<section class="foot-address text-xs-center text-sm-center text-md-left">
			...
			<!-- Links Section Starts -->
				<section class="footer-links-section text-xs-center text-sm-center text-md-left">
				<!-- Nested Row Starts -->
					<div class="row">
					<!-- Link Col #1 Starts -->
			...
			<!-- Copyright Starts -->
				<p class="copyright text-center mb-0">
					All Rights Reserved &copy; 2010 - 2018  Food Bingo  Service.
				</p>
			<!-- Copyright Ends -->
			</div>
		<!-- Nested Container Ends -->
